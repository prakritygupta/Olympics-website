<html>
    ...
    <div class="menu-btn" style="width:100%; display: flex; justify-content: center;">
        ...
        <img class="riologo" alt="Tokyo2020 Logo" style="float: left; padding-left: 250px;padding-top:10px; padding-bottom:10px;"src="https://img.olympicchannel.com/images/image/private/f_auto/w_300/v1552235080/primary/jux5g5vrxv5fnglq93yj">
        <div class="div" style="padding-top:70px; padding-right:170px;">        
            <table class="content" style="width: 50%; float: right;">
                <tr>
                    <th>Date</th>
                    <td class="td">23 JULY- 8 AUGUST</td>
                </tr>
                <tr>
                    <th>Country</th>
                    <td>JAPAN</td>
        ...
        <br><br>
        <img src="https://img.olympicchannel.com/images/image/private/f_auto/t_s_pog_overview_hero_lg/primary/nrosjoo363yog5hsj1bs" alt="stadium"style="margin-right:auto;float:center;display: block;margin-left: auto;">
    </body>
</html>