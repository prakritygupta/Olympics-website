<html>
    ...
    <div class="menu-btn" style="width:100%; display: flex; justify-content: center;">
        ...
        <img class="riologo" alt="Beijing2022 Logo" style="float: left; padding-left: 250px;"src="https://img.olympicchannel.com/images/image/private/f_auto/w_300/primary/lqdmzt3zbmjoqlkyxeay">
        <div class="div" style="padding-top:60px; padding-right:150px;">        
            <table class="content" style="width: 50%; float: right;">
                <tr>
                    <th>Date</th>
                    <td class="td">4 FEBRUARY- 20 FEBRUARY</td>
                </tr>
                <tr>
                    <th>Country</th>
                    <td>CHINA</td>
        ...
        <br><br>
        <img src="https://img.olympicchannel.com/images/image/private/f_auto/t_s_pog_overview_hero_lg/v1649062865/primary/n5gcitwteon12zw56gei" alt="stadium" style="margin-right:auto;float:center;display: block;margin-left: auto;">
    </body>
</html>