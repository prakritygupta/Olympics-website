<html>
    ...
    <div class="menu-btn" style="width:100%; display: flex; justify-content: center;">
        ...
        <img class="riologo" alt="Lausanne2020 Logo" style="float: left; padding-left: 270px;"src="https://img.olympicchannel.com/images/image/private/f_auto/w_300/primary/r33mv0gvqlcxddx64zkc">
        <div class="div" style="padding-top:60px; padding-right:270px;">        
            <table class="content" style="width: 40%; float: right;">
                <tr>
                    <th>Date</th>
                    <td class="td">9 JANUARY- 23 JANUARY</td>
                </tr>
                <tr>
                    <th>Country</th>
                    <td>SWITZERLAND</td>
        ...
        <br><br><br><br><br>
        <img src="https://img.olympicchannel.com/images/image/private/f_auto/t_s_pog_overview_hero_lg/primary/inggn3pgfazlu2vag82v" alt="stadium" style="margin-right:50px;float:center;display: block;margin-left: 300px; margin-top:150px;">
    </body>
</html>