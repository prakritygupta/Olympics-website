<html>
    ...
    <div class="menu-btn" style="width:100%; display: flex; justify-content: center;">
        ...
        <img class="riologo" alt="Rio2016 Logo" style="float: left; padding-left: 250px;"src="https://upload.wikimedia.org/wikipedia/en/thumb/d/df/2016_Summer_Olympics_logo.svg/1200px-2016_Summer_Olympics_logo.svg.png">  
        <div class="div" style="padding-top:80px; padding-right:150px;">        
            <table class="content" style="width: 50%; float: right;">
                <tr>
                    <th>Date</th>
                    <td class="td">5 AUGUST-22 AUGUST</td>
                </tr>
                <tr>
                    <th>Country</th>
                    <td>BRAZIL</td>
        ...
        <br><br>
        <img src="https://img.olympicchannel.com/images/image/private/f_auto/t_s_pog_overview_hero_xl/primary/himzvivqxrl4hqtcz80w" alt="stadium">
    </body>
</html>