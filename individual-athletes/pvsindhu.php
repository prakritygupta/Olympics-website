<html>
    ...
    <br>
        <div class="heading-photo">
            <div class="mainphoto">
            <img src="https://img.olympicchannel.com/images/image/private/f_auto/t_1-1_300/primary/gsfzbbjmgyi8atet8iot" alt="P.V.Sindhu" style="border-radius:50%;"> 
            </div>
            <div class="heading">
            <p>P.V.SINDHU</p>
            </div>
        ...
        <br>
        <br>
        <p style="text-align: center;font-size: 25px; font-family: Verdana, Geneva, Tahoma, sans-serif;">
        <a href="badminton.php" style="color: black; text-decoration:none;font-family: Verdana, Geneva, Tahoma, sans-serif;"><img src="https://gstatic.olympics.com/s1/f_auto/t_s_athlete_medal/static/dark/pictograms/2022/bdm.svg" alt="badminton" style="width:70px;margin-right: 10px; ">Badminton</a>
        <img src="https://gstatic.olympics.com/s1/f_auto/t_s_pog_flag/static/flag/4x3/in" style="width: 70px;margin-left:80px;">  Team India
        </p>
        <br>
        <br>
        <table class="table table-bordered">
              <tr>
                <td style="color:#7d7b7b; padding-left: 100px;">Olympic Medals</td>
                <td>1-Silver; 1-Bronze</td>
              </tr>
              <tr>
                <td style="color:#7d7b7b;padding-left: 100px;">Games Participations</td>
                <td>2</td>
              </tr>
              <tr>
                <td style="color:#7d7b7b;padding-left: 100px;" >First Olympic Games</td>
                <td>Rio 2016</td>
              </tr>
              <tr>
                <td style="color:#7d7b7b;padding-left: 100px;">Year of Birth</td>
                <td>1995</td>
              </tr>  
          </table>  
          <div class="info">
          ...
          <p class="athlete-info">Pusarla Venkata Sindhu is a sporting icon of the 21st century and a shining beacon for sportswomen in India. The shuttler has risen to the top of the world in the last decade, winning dozens of titles across the globe.<br><br>

            After becoming the first Indian woman to win a silver medal at the Olympics and gold at the BWF World Championships, PV Sindhu added another piece of metal to her glittering cabinet by winning her second straight Olympic medal - a bronze at Tokyo 2020, thus becoming the first Indian woman to win two Olympic medals.<br><br>
            
            PV Sindhu’s consistency at the highest level can somewhat be attributed to the sporting genes she inherited from her parents. Born July 5, 1995, in Hyderabad, Andhra Pradesh to parents who were both volleyball players at the national level, sport already coursed through PV Sindhu’s veins since she was born.<br><br>
            
            While her parents may have been volleyball players, badminton caught PV Sindhu’s fancy after watching Pullela Gopichand in action, and by the age of eight, she was a regular at the sport.</p>
          </div>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
    </body>
</html>